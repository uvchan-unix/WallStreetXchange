...
public class StockCollections {
    ...
    public static void main(String[] args) {
        ...
        obj.insert("Wipro Ltd", "WIPRO", "BSE/NSE");
        // Forex Stocks
        obj.insert("USD/SGD", "USDSGD", "Forex");
        obj.insert("USD/HKD", "USDHKD", "Forex");
        obj.insert("EUR/GBP", "EURGBP", "Forex");
        obj.insert("USD/INR", "USDINR", "Forex");
        obj.insert("USD/AUD", "USDAUD", "Forex");
        obj.insert("GBP/JPY", "GBPJPY", "Forex");
        obj.insert("EUR/JPY", "EURJPY", "Forex");
        obj.insert("AUD/JPY", "AUDJPY", "Forex");
        obj.insert("USD/NOK", "USDNOK", "Forex");
        obj.insert("USD/SEK", "USDSEK", "Forex");
        obj.insert("EUR/AUD", "EURAUD", "Forex");
        obj.insert("EUR/CHF", "EURCHF", "Forex");
        obj.insert("GBP/CHF", "GBPCHF", "Forex");
        obj.insert("AUD/CAD", "AUDCAD", "Forex");
        obj.insert("NZD/USD", "NZDUSD", "Forex");
        obj.insert("USD/DKK", "USDDKK", "Forex");
        obj.insert("GBP/CAD", "GBPCAD", "Forex");
        obj.insert("GBP/AUD", "GBPAUD", "Forex");
        obj.insert("EUR/CAD", "EURCAD", "Forex");
        obj.insert("EUR/SEK", "EURSEK", "Forex");
        obj.insert("NZD/JPY", "NZDJPY", "Forex");
        obj.insert("AUD/NZD", "AUDNZD", "Forex");
        obj.insert("USD/CNH", "USDCNH", "Forex");
        obj.insert("USD/ZAR", "USDZAR", "Forex");
        obj.insert("EUR/NZD", "EURNZD", "Forex");
        obj.insert("EUR/NOK", "EURNOK", "Forex");
        obj.insert("EUR/TRY", "EURTRY", "Forex");
        obj.insert("USD/TRY", "USDTRY", "Forex");
        obj.insert("USD/RUB", "USDRUB", "Forex");
        obj.insert("USD/MXN", "USDMXN", "Forex");
        obj.insert("USD/BRL", "USDBRL", "Forex");
        obj.insert("USD/THB", "USDTHB", "Forex");
        obj.insert("USD/IDR", "USDIDR", "Forex");
        obj.insert("USD/KRW", "USDKRW", "Forex");
        obj.insert("USD/PHP", "USDPHP", "Forex");
        obj.insert("USD/TWD", "USDTWD", "Forex");
        obj.insert("USD/MYR", "USDMYR", "Forex");

        // Other Metals
        obj.insert("Copper", "XCUUSD", "Metals");
        obj.insert("Nickel", "XNIUSD", "Metals");
        obj.insert("Zinc", "XZNUSD", "Metals");
        obj.insert("Lead", "XPBUSD", "Metals");
        obj.insert("Aluminium", "XALUSD", "Metals");
        obj.insert("Rhodium", "XRHUSD", "Metals");
        obj.insert("Iridium", "XIRUSD", "Metals");
        obj.insert("Osmium", "XOSUSD", "Metals");
        obj.insert("Ruthenium", "XRUSD", "Metals");
        obj.insert("Gold/Silver Ratio", "XAU/XAG", "Metals");
        obj.insert("Gold/Platinum Ratio", "XAU/XPT", "Metals");
        obj.insert("Gold/Palladium Ratio", "XAU/XPD", "Metals");

        // Forex Stocks
        obj.insert("EUR/CNY", "EURCNY", "Forex");
        obj.insert("GBP/SGD", "GBPSGD", "Forex");
        obj.insert("USD/CHF", "USDCHF", "Forex");
        obj.insert("USD/SGD", "USDSGD", "Forex");
        obj.insert("AUD/CHF", "AUDCHF", "Forex");
        obj.insert("CAD/JPY", "CADJPY", "Forex");
        obj.insert("CHF/JPY", "CHFJPY", "Forex");
        obj.insert("EUR/AUD", "EURAUD", "Forex");
        obj.insert("EUR/GBP", "EURGBP", "Forex");
        obj.insert("EUR/HKD", "EURHKD", "Forex");
        obj.insert("EUR/NZD", "EURNZD", "Forex");
        obj.insert("GBP/AUD", "GBPAUD", "Forex");
        obj.insert("GBP/CAD", "GBPCAD", "Forex");
        obj.insert("GBP/JPY", "GBPJPY", "Forex");
        obj.insert("NZD/CAD", "NZDCAD", "Forex");
        obj.insert("NZD/CHF", "NZDCHF", "Forex");
        obj.insert("NZD/JPY", "NZDJPY", "Forex");
        obj.insert("USD/CNH", "USDCNH", "Forex");
        obj.insert("USD/HKD", "USDHKD", "Forex");
        obj.insert("USD/INR", "USDINR", "Forex");
        obj.insert("USD/JPY", "USDJPY", "Forex");
        obj.insert("AUD/JPY", "AUDJPY", "Forex");
        obj.insert("AUD/NZD", "AUDNZD", "Forex");
        obj.insert("CAD/CHF", "CADCHF", "Forex");
        obj.insert("EUR/CHF", "EURCHF", "Forex");
        obj.insert("EUR/JPY", "EURJPY", "Forex");
        obj.insert("GBP/NZD", "GBPNZD", "Forex");
        obj.insert("NZD/USD", "NZDUSD", "Forex");
        obj.insert("USD/CAD", "USDCAD", "Forex");
        obj.insert("USD/SEK", "USDSEK", "Forex");
        obj.insert("USD/THB", "USDTHB", "Forex");

        // Other Metals
        obj.insert("Tin", "XTIUSD", "Metals");
        obj.insert("Steel", "XSTUSD", "Metals");
        obj.insert("Cobalt", "XCOUSD", "Metals");
        obj.insert("Titanium", "XTNUSD", "Metals");
        obj.insert("Vanadium", "XVAUSD", "Metals");
        obj.insert("Magnesium", "XMGUSD", "Metals");
        obj.insert("Lithium", "XLITHUSD", "Metals");
        obj.insert("Antimony", "XANTUSD", "Metals");
        obj.insert("Manganese", "XMNUSD", "Metals");
        obj.insert("Zirconium", "XZIRUSD", "Metals");
        obj.insert("Tungsten", "XTUUSD", "Metals");
        obj.insert("Bismuth", "XBIUSD", "Metals");
        obj.insert("Cadmium", "XCADUSD", "Metals");
        obj.insert("Indium", "XINDUSD", "Metals");
        obj.insert("Germanium", "XGERUSD", "Metals");
        obj.insert("Rhenium", "XREUSD", "Metals");
        obj.insert("Scandium", "XSCUSD", "Metals");
        obj.insert("Tellurium", "XTEUSD", "Metals");
        obj.insert("Hafnium", "XHAFUSD", "Metals");
        obj.insert("Niobium", "XNBUSD", "Metals");

        JSONArray json = obj.getStocks("f");
